...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_abhinav_goldmark_toc",
        importpath = "github.com/abhinav/goldmark-toc",
        sum = "h1:QJsKKGbdVeCWYMB11hSkNuZLuIzls7Y4KBZfwTkBB90=",
        version = "v0.2.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_dietsche_rfsnotify",
        importpath = "github.com/dietsche/rfsnotify",
        sum = "h1:b3QvpXLSx1U13VM79rSkA+6Xv4lmT/urEMzA36Yma0U=",
        version = "v0.0.0-20200716145600-b37be6e4177f",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_jeffail_tunny",
        importpath = "github.com/Jeffail/tunny",
        sum = "h1:chtpdz+nUtaYQeCKlNBg6GycFF/kGVHOr6A3cmzTJXs=",
        version = "v0.1.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:sdr3Phw2+f8Px8HE5sd1EHdj1aV3yUwed/uZXChLFsk=",
        version = "v1.13.0",
    )
