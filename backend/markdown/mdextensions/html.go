...
func (r *Renderer) renderHeading(w util.BufWriter, source []byte, node ast.Node, entering bool) (ast.WalkStatus, error) {
	...
	if entering {
		...
		switch n.Level {
		case 1:
			_, _ = w.WriteString("1 class='text-3xl font-black text-slate-900 tracking-tight text-center dark:text-slate-200  pb-6 my-3'")
		case 2:
			_, _ = w.WriteString("2 class='text-2xl font-extrabold text-slate-900 tracking-tight dark:text-slate-200  py-2'")
		case 3:
			_, _ = w.WriteString("3 class='text-xl  font-extrabold	text-slate-900 tracking-tight dark:text-slate-200  py-1.5'")
		case 4:
			_, _ = w.WriteString("4 class='text-lg  font-bold	    text-slate-900 tracking-tight  dark:text-slate-200  py-1.5'")
		case 5:
			_, _ = w.WriteString("5 class='text-base font-bold 	  text-slate-900 tracking-tight  dark:text-slate-200  py-1'")
		case 6:
			_, _ = w.WriteString("6 class='text-base font-semibold	text-slate-900 tracking-tight  dark:text-slate-200  py-0.5'")
		default:
...
func (r *Renderer) renderCodeBlock(w util.BufWriter, source []byte, n ast.Node, entering bool) (ast.WalkStatus, error) {
	if entering {
		_, _ = w.WriteString(`<div class="relative z-10 mx-2 my-6 col-span-3 dark:bg-slate-800 bg-white font-base rounded-md shadow-lg  ring-1 ring-slate-300 dark:ring-1 dark:ring-white/10 dark:ring-inset">
		<div class="relative flex text-slate-400 text-sm leading-6">
				<div class="mt-2 flex-none dark:text-sky-300 text-slate-600 border-t border-b border-t-transparent border-b-slate-500 dark:border-b-sky-300 px-4 py-1 flex items-center">language:code</div>
...
func (r *Renderer) renderCodeSpan(w util.BufWriter, source []byte, n ast.Node, entering bool) (ast.WalkStatus, error) {
	if entering {
		if n.Attributes() != nil {
			...
			_, _ = w.WriteString("<code class='bg-slate-200 dark:bg-slate-800 mx-1 px-1 rounded-md'>")
		}
