    ...
    <div className="sticky top-0 z-50 w-full backdrop-blur flex-none transition-colors 
        ...
        <Popover>
            <div className="flex flex-row justify-between items-center py-2 
                ...
                <div className="flex  gap-x-3	 justify-center items-center px-3 md:px-6	 mx-3  md:mx-6  md:border-l border-slate-200 ">
                {/* <button  onClick={() => { setlangzh(!langzh) }} className={`${langzh && "hidden"}`}>
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" className="block w-6 h-6  hover:text-sky-500 cursor-pointer false" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <button onClick={() => { setlangzh(!langzh) }} className={`${!langzh && "hidden"}`}>
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1070 1024" className="block w-6 h-6  hover:text-sky-500 cursor-pointer false" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="hidden md:flex items-center" >
                        <MdLogin className=' block w-6 h-6  hover:text-sky-500 cursor-pointer' onClick={handleSignOut}   />
