...
export default function Profile({openUpdateProfile, setOpenUpdateProfile}) {
  ...
  return (
    <section className="py-5 w-full border-collapse text-xl">
      <UpdateUser open={openUpdateUser} setOpen={setOpenUpdateUser} bio={bio}/>
      <div className="relative flex flex-col-reverse bg-slate-100 rounded-lg px-4 md:px-16 py-6 dark:bg-slate-800 dark:highlight-white/5">
        ...
        <div className="flex items-center space-x-4">
            <img onClick={() => {  setOpenUpdateProfile(!openUpdateProfile) }} src={`${backend_base_url}static_get/${userid}/profile.png`} alt="" className="flex-none w-24 h-24 rounded-full object-cover" loading="lazy" decoding="async" />
